...
class AdminController extends BaseController
{
    ...
    */
    public function create()
    {
        ...
        return view('admin.admin.create', compact('admins','zones', 'page', 'countries', 'main_menu', 'sub_menu', 'roles', 'services'));
    }
    ...
    public function getById(AdminDetail $admin)
    {
        ...
        return view('admin.admin.update', compact('item', 'services','zones', 'page', 'countries', 'main_menu', 'sub_menu', 'roles'));
    }
