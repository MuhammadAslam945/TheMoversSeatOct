...
class ZoneController extends BaseController
{
    ...
    */
    ...
    public function store(CreateZoneRequest $request)
    {
       ...
       // dd($request->all());
        ...
        $created_params['longitude'] = $request->input('lng');
        $created_params['latitude'] = $request->input('lat');
       //dd($request->input('lng'),$request->input('lat'));
    ...
    */
    public function update(Zone $zone, CreateZoneRequest $request)
    {
        ...
        $updated_params['city'] = $request->input('zone_city');
        $updated_params['latitude'] = $request->input('zone_latitude');
        $updated_params['longitude'] = $request->input('zone_longitude');
