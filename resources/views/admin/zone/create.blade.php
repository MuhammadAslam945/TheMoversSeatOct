                        ...
                        <form method="post" class="form-horizontal" action="{{url('zone/store')}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lng" id="lng" class="form-control" placeholder="Enter Longitude">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="zone_name" type="text" name="zone_name"
                                            value="{{ old('zone_name') }}" placeholder="@lang('view_pages.enter_name')"
                                            required>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input name="search-box" id="search-box" class="form-control controls" type="text"
