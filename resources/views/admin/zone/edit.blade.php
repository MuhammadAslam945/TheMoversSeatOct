                    ...
                    <div class="col-sm-12">
                        <form method="post" class="form-horizontal" action="{{url('zone/update',request()->id)}}"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="admin_id" id="zone_admin" class="form-control" required>
                                            ...
                                            <option value="{{$service->id}}" {{ $service->id ==
                                                $zone->service_location_id ? 'selected' : '' }}>{{$service->name}}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label> @lang('view_pages.city') <sup>*</sup></label>
                                        <input class="form-control" id="zone_city" type="text" name="zone_city"
                                            value="{{old('city',$zone->city)}}"
                                            placeholder="@lang('view_pages.enter_city')" required>
                                        <span class="text-danger">{{ $errors->first('zone_city') }}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label> Longitude <sup>*</sup></label>
                                        <input class="form-control" id="zone_longitude" type="text" name="zone_longitude"
                                            value="{{old('longitude',$zone->longitude)}}"
                                            placeholder="@lang('view_pages.enter_longitude')" required>
                                        <span class="text-danger">{{ $errors->first('zone_longitude') }}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label> Latitude <sup>*</sup></label>
                                        <input class="form-control" id="zone_latitude" type="text" name="zone_latitude"
                                            value="{{old('latitude',$zone->latitude)}}"
                                            placeholder="@lang('view_pages.enter_latitude')" required>
                                        <span class="text-danger">{{ $errors->first('zone_latitude') }}</span>
                                    </div>
                                </div>
